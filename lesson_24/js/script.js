...
function myFunction(a, b) {
	if (isNaN(a) || isNaN(b)) {/* за допомогою функції isNan перевіряємо чи являються значення a та b числами*/
		return "Введені дані не є числами";
	}
	const result = a / b;
